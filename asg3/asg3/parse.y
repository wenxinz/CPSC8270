...
%token<str> NAME 
%token NEWLINE NOT NOTEQUAL NUMBER
...
%type<num> suite stmt compound_stmt plus_stmt plus_except opt_FINALLY
%type<num> if_stmt while_stmt for_stmt try_stmt with_stmt funcdef star_ELIF
