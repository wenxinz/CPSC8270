...
%type<intNumber> augassign pick_PLUS_MINUS pick_multop pick_unop
%type<node> star_EQUAL term factor power test opt_test or_test and_test not_test
%type<node> atom expr_stmt expr xor_expr and_expr shift_expr arith_expr 
%type<node> testlist pick_yield_expr_testlist opt_yield_test pick_yield_expr_testlist_comp
%type<node> yield_expr lambdef comparison testlist_comp 
